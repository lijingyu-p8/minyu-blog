...
![image-20210805063859710](/ElasticSearch/01/windows.png)
...
![image-20210821205538638](/ElasticSearch/01/安装-1.png)
...
![image-20210821210223288](/ElasticSearch/01/安装问题-config-1.png)
...
![image-20210821210436068](/ElasticSearch/01/linux-es启动-1.png)

![image-20210821210606027](/ElasticSearch/01/linux-es启动成功.png)

#### 2、访问测试

1. 浏览器访问

   ![image-20210821211429396](/ElasticSearch/01/浏览器访问测试-1.png)

2. Linux访问

   ![image-20210821211522339](/ElasticSearch/01/linux访问测试-1.png)
...
![head](/ElasticSearch/01/head.png)
